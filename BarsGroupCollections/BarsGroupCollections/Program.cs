...
namespace BarsGroupCollections
{
    public class Program
    {
        ...
        {
            Entity first = new Entity { Id = 1, ParentId = 0, Name = "Root entity" };
            Entity second = new Entity { Id = 2, ParentId = 1, Name = "Child of 1 entity" };
            Entity third = new Entity { Id = 3, ParentId = 1, Name = "Child of 1 entity" };
            Entity fourth = new Entity { Id = 4, ParentId = 2, Name = "Child of 2 entity" };
            Entity fifth = new Entity { Id = 5, ParentId = 4, Name = "Child of 4 entity" };

            List<Entity> listEntity = new List<Entity> { first, second, third, fourth, fifth };
